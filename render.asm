...
.l1:    
    ...
    VFNMADD231PS temp1,z,sin_rx
    VMOVAPD y,temp1
    VFMADD231PS temp2, z,cos_rx
    VMOVAPD z,temp2
    ...
    VFNMADD231PS temp1,x,sin_ry
    VMOVAPD z,temp1
    VFMADD231PS temp2, x,cos_ry
    VMOVAPD x,temp2
    ...
    VFNMADD231PS temp1,y,sin_rz
    VMOVAPD x,temp1
    VFMADD231PS temp2, y,cos_rz
    VMOVAPD y,temp2
